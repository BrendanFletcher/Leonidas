...
import com.endeavour.saddam.pharmacyautomation.utils.GetNearbyPlacesData;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // if (intentThatStartedThisActivity.hasExtra(Constants.Key.LOCATION)) {
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyBA_qrqvACj5SI3TwyYIUkhCMPLdWtrWe4");
    ...
    public boolean checkLocationPermission(){
        if (ContextCompat.checkSelfPermission(this,
            ...
            Log.d("onCheckLocation","Check permission failed.");
            return false;
        } else {
            Log.d("onCheckLocation","Check permission succeeded.");
            return true;
        }
    }
